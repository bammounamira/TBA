...
class Actions:
    ...
    def play(self, player, game):
        ...
        """
        # Start the timer
        timer_thread = threading.Thread(target=self.start_timer, args=(120, player, game))
